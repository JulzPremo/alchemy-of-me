    ...
    <>
      ...
      <main className="web-projects-container">
        <div className="section-bubble">
          ...
          {/* --- Project 1: Medieval Kreations --- */}
          <section className="project-list">
            <div className="section_bubble2">
              <h2 className="project-title">🛡️ Medieval Kreations</h2>
              <p className="project-subtitle">
                <strong>Course Project</strong> | UX & Web Design Case Study
              </p>
          ...
          {/* --- Project 2: Animated Tarot Reading --- */}
          <section className="project-list">
            <div className="section_bubble2">
              <h2 className="project-title">🔮 Animated Tarot Reading</h2>
              <p className="project-subtitle"><strong>WEB 350 - Web Media</strong></p>
