    ...
    <>
      ...
      <div className="section-bubble">
        ...
        <p className="page-description">
          The story behind the creator — where tech meets storytelling, empathy, and purpose.
        </p>
        ...
        <div className="section_bubble2">
          <h2>🌱 My Journey</h2>
          <p>
            My path into tech was paved by years of experience in customer service and technical support — roles that taught me
          ...
          <p>
            ...
            My goal now is to transition fully into a web development role — combining my passion for design, storytelling, and structure to
        ...
        <div className="section_bubble2">
          <h2>💻 What I Do</h2>
          <p>
            I design and develop websites with both form and function in mind — but more importantly, I build with people in mind.
          ...
          <p>
            My technical skills are backed by lived experience — I know how to ask the right questions, manage expectations,
